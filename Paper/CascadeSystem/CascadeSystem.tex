...
%		$T_{1,ses,o}$	&	673 K\\
%		$s_{se}$			&	10 s$^{-1}$\\
%		$U_{se,1}$	&	30 W/(m$^2\cdot$K)\\
%		$U_{se,2}$	&	150 W/(m$^2\cdot$K)\\
%		$A_{se,1}$	&	8 m$^2$\\
%		$A_{se,2}$	&	8 m$^2$\\
%		$k_{se}$		&	1.4\\
%		$\gamma_{se}	$	&	3.375\\
...
\nomenclature{$v_w$}{Ambient wind speed, m/s}
%\nomenclature{$T_{dr,i}$}{Dish inlet temperature, K}
%\nomenclature{$T_{dr,o}$}{Dish outlet temperature, K}
%\nomenclature{$p_{dr}$}{Air pressure in dish, Pa}
\nomenclature[S]{$dc$}{Dish collector}
\nomenclature[G]{$\Delta{}T_{3,2,min}$}{Minimum temperature difference between oil and water in the oil-to-water heat exchanger, K}
%\nomenclature{$T_{tr,o}$}{Trough outlet temperature, K}
%\nomenclature{$p_{tr}$}{Air pressure in trough, Pa}
\nomenclature[S]{$tc$}{Trough collector}
\nomenclature{$T_{1,ses,o}$}{Air temperature after heating Stirling engine, K}
\nomenclature[S]{$se$}{Stirling engine}
\nomenclature[S]{$ses$}{Stirling engine array}
\nomenclature[S]{$tb$}{Steam turbine}
\nomenclature[S]{$dr$}{Dish receiver}
\nomenclature[S]{$tr$}{Trough receiver}
\nomenclature[S]{$da$}{Deaerator}
\nomenclature{$s_{se}$}{Speed of Stirling engine, s$^{-1}$}
\nomenclature{$U_{se,1}$}{Overall heat transfer coefficient of Stirling engine at air side, W/(m$^2\cdot$K)}
\nomenclature{$U_{se,2}$}{Overall heat transfer coefficient of Stirling engine at water side, W/(m$^2\cdot$K)}
\nomenclature{$T_{tb,s}$}{Main steam temperature of turbine, K}
\nomenclature{$p_{tb,s}$}{Main steam pressure of turbine, Pa}
\nomenclature{$p_{tb,c}$}{Exhaust pressure of turbine, Pa}
\nomenclature{$T_{tb,s,d}$}{Designed mean steam temperature of turbine, K}
%\nomenclature{$p_{da}$}{Pressure of deaerator, Pa}
...
%\nomenclature[G]{$k_{ins}$}{Thermal conductivity of receiver insulating layer, W/(m$\cdot$K)}
\nomenclature[G]{$\epsilon$}{Emissivity}
\nomenclature[G]{$\delta$}{Thicknes, m}
\nomenclature[G]{$\delta_{a}$}{Thickness of air tube in volumetric receiver, m}
%\nomenclature{$d_{dr,i}$}{Inner diameter of air tube, m}
\nomenclature[G]{$\theta_{dr}$}{Dish collector aperture angle, rad (0 is horizontal, $\pi/2$ is vertically down)}
...
\nomenclature{$k_{se}$}{Specific heat ratio of the working gas in Stirling engine}
...
\nomenclature[S]{$ref$}{Reflected radiation}
%\nomenclature{$q_{dr,1}$}{Energy absorbed by air in the dish collector}
...
\nomenclature[S]{$ins$}{Insulating layer of the dish receiver}
\nomenclature[S]{$cond$}{Conduction}
\nomenclature[S]{$conv$}{Convection}
\nomenclature[S]{$rad$}{Radiation}
\nomenclature[S]{$emit$}{Emitted radiation}
\nomenclature[S]{$nat$}{Nature convection}
\nomenclature[S]{$for$}{Forced convection}
\nomenclature[S]{$diff$}{Difference between cascade system and separate systems}
\nomenclature[S]{$i$}{Inner}
\nomenclature[S]{$o$}{Outer}
...
%\nomenclature{$T_{ins}$}{Temperature of insulating outside layer, K}
...
\end{split}
\end{equation*}
\nomenclature{$k$}{Thermal conductivity, W/(m$\cdot$K)}
...
%\nomenclature{$d_{tr,i}$}{Inner diameter of trough receiver, m}
...
\begin{table}[htbp]
	...
	\label{tab:tc}
\end{table}
%\nomenclature{$d_{tr,o}$}{Outer diameter of trough receiver, m}
\nomenclature{$Fe$}{Soiling factor}
\nomenclature{$w_{tc}$}{Width of trough collector, m}
\nomenclature[G]{$\phi_{tc}$}{Incidence angle of trough collector, rad}
...
\nomenclature{$q_{m}$}{Mass flow rate, kg/s}
...
\end{table}
\nomenclature[G]{$\eta$}{Efficiency of cascade system}
\nomenclature[G]{$\eta_s$}{Efficiency of separate systems}
%\nomenclature[G]{$\eta_{se}$}{Efficiency of Stirling engine array}
%\nomenclature[G]{$\eta_{se,s}$}{Efficiency of Stirling engines in separate dish system}
%\nomenclature[G]{$\eta_{diff}$}{Efficiency difference of cascade system and separate systems, $\eta-\eta_s$}
%\nomenclature{$P_{se}$}{Power of Stirling engine array, W}
%\nomenclature{$P_{se,s}$}{Total power of Stirling engines in separate dish system, W}
...
if $A(x)=Px$, $x$ from $0$ to $L$, $T(x)$ from $T_{tr,i}$ to \nomenclature[S]{$o$}{Outlet}$T_{tr,o}$, 
